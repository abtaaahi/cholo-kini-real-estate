...
const PrivacyPolicy = () => {
  return (
    <div className="legal-policies">
      ...
      <p>Welcome to the Cholo Kini - Real Estate , We respect your privacy and want to protect your personal information. To learn more, please read this Privacy Policy.
...
Daraz shall collect the following information where you are a buyer:
...
Furthermore, you also have the right to ask us to delete your data. If you would like to have your data deleted, fill out the Account Deactivation/Deletion Request Form (“Deletion Request”) or email your request to customer.bd@care.daraz.com. Once your request is received, we follow an internal deletion process to make sure that your data is safely removed in the next fifteen (15) working days. You'll be contacted for verification and your account will be deleted after necessary protocols are conformed to. Read more about the deletion process here.
Minors
